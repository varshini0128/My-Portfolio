        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-8">
            {education.map((edu, index) => (
              <div 
                key={index}
                className="relative bg-slate-600 rounded-xl border border-slate-500 hover:border-blue-400/50 transition-all duration-300 p-6 group"
              >
                {/* Status indicator */}
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-400 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <GraduationCap className="text-white" size={24} />
                    </div>
                  </div>

                  <div className="flex-grow">
                    <h3 className="text-xl font-bold text-blue-400 mb-2 group-hover:text-blue-400 transition-colors duration-300">
                      {edu.degree}
                    </h3>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-blue-100 font-semibold">{edu.score}</span>
                    </div>
